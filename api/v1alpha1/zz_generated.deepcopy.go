...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *APIMockCondition) DeepCopyInto(out *APIMockCondition) {
	*out = *in
	in.LastProbeTime.DeepCopyInto(&out.LastProbeTime)
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIMockCondition.
func (in *APIMockCondition) DeepCopy() *APIMockCondition {
	if in == nil {
		return nil
	}
	out := new(APIMockCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *APIMockStatus) DeepCopyInto(out *APIMockStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]*APIMockCondition, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(APIMockCondition)
