...
func newMockContainer(resource *v1alpha1.APIMock) corev1.Container {
	...
	cnWatch := corev1.EnvVar{
		Name:  "WATCH",
		Value: strconv.FormatBool(resource.Spec.Watch),
	}
...
func newDocContainer(resource *v1alpha1.APIMock) corev1.Container {
	var ports []corev1.ContainerPort
	ports = append(ports, corev1.ContainerPort{
...
func newVolumes(resource *v1alpha1.APIMock) []corev1.Volume {
